...
Starting in Bayesian statistics, Basic knowledge in different modelling techniques (RandomForest, SDM, JSDM)
...
<span style="font-weight:600;">Database</span>: <br>SQL <br>(Basic knowledge)<br>

<span style="font-weight:600;">Automation/reports</span>: <br>Markdown,LaTeX, Git, Bash<br> 
